...
| `path` | `/health`, `/api/v1/admin/login`, `/api/v1/contractors/:id`, etc. | The **route pattern** (not the actual URL with IDs — this prevents thousands of unique label combinations) |
