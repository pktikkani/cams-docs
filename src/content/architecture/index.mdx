...
```mermaid
graph TD
    CA["📱 Contractor App — iOS / Android"] -->|HTTPS REST API| BE
    SA["📷 Scanner App — iOS / Android"] -->|HTTPS REST API| BE

    BE["⚙️ Go Backend - Fiber"]
    ...
    BE --> Backend_Services
    BE -->|SQL| DB[("🐘 PostgreSQL — Railway")]
    BE -->|Nonce/Cache| RD[(Redis)]
    AP["🖥️ Admin Portal — Next.js 16"] -->|SQL| DB
